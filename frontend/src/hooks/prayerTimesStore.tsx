...
} from '@/services/prayer/prayerTimes';
import { BUILT_IN_RECITERS, SILENT_RECITER_ID, getCustomAdhanBlob, CustomAdhanMeta, listCustomAdhans } from '@/services/audio/adhanAudio';
import { useMusicPlayer } from '@/hooks/musicPlayer';
import { toast } from '@/utils/toast';
import { sounds } from '@/services/audio/sounds';
import { scheduleNativeAdhanForDay, ensureNativeAdhanPermissions, isNativeApp } from '@/services/audio/nativeAdhan';
import { initPrayerReminderChannel, scheduleAllNativePrayerReminders } from '@/services/prayer/prayerNativeReminders';
...
function loadSettings(): PrayerTimesSettings {
  const parsed = readJSON<Record<string, unknown>>(SETTINGS_KEY);
