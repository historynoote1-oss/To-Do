...
import { resetWithRecoveryCode } from '@/services/api';
...
export default function ForgotPasswordForm({ onBack }: { onBack: () => void }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      const resetResult = await resetWithRecoveryCode(username.trim(), recoveryCode.trim(), password, confirmPassword);
      sounds.success();
      setNewRecoveryCode(resetResult.recoveryCode);
    } catch (err) {
      sounds.error();
