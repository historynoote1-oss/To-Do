...
import { PriorityPicker } from '@/pages/life-areas/Priority';
import { CategoryPicker } from '@/pages/life-areas/Category';
import { LifeAreaPicker } from '@/pages/life-areas/LifeArea';
import QuickCreateLifeArea from '@/pages/life-areas/QuickCreateLifeArea';
import { PriorityKey, priorityOf } from '@/utils/priority';
import { CategoryKey, categoryOf, requiresParentGoal, goalLabelFor, CHILD_CATEGORY_OF, PARENT_CATEGORY_OF, MONTH_NAMES, WEEK_LABELS, DAY_OF_WEEK_NAMES } from '@/utils/category';
import { LifeAreaData } from '@/utils/lifeArea';
import { DynamicIcon } from '@/utils/icons';
import { sounds } from '@/services/audio/sounds';
import { getGoalOptions, GoalOption } from '@/services/api';
