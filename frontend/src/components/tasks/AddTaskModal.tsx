...
import { CategoryPicker } from '@/components/life-areas/Category';
import { LifeAreaPicker } from '@/components/life-areas/LifeArea';
import QuickCreateLifeArea from '@/components/life-areas/QuickCreateLifeArea';
import { PriorityKey, priorityOf } from '@/lib/core/priority';
import { CategoryKey, categoryOf, requiresParentGoal, goalLabelFor, CHILD_CATEGORY_OF, PARENT_CATEGORY_OF, MONTH_NAMES, WEEK_LABELS, DAY_OF_WEEK_NAMES } from '@/lib/core/category';
import { LifeAreaData } from '@/lib/core/lifeArea';
import { DynamicIcon } from '@/lib/core/icons';
import { sounds } from '@/lib/audio/sounds';
import { getGoalOptions, GoalOption } from '@/lib/api/api';
