...
import AccountPasswordConfirmModal from '@/components/auth/AccountPasswordConfirmModal';
import { DynamicIcon } from '@/lib/core/icons';
import { sounds } from '@/lib/audio/sounds';
import { CategoryKey, categoryOf, MONTH_NAMES, WEEK_LABELS, DAY_OF_WEEK_NAMES } from '@/lib/core/category';
import { LifeAreaData, hexToSoftBg } from '@/lib/core/lifeArea';
import type { NewTaskPayload } from '@/components/tasks/AddTaskModal';
import type { GoalOption, TrashedYear } from '@/lib/api/api';
import {
  getTrash,
