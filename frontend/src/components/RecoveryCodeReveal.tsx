...
export default function RecoveryCodeReveal({
  ...
  return (
    <div className="auth-container">
      <h1>
        <DynamicIcon name="key" size={20} /> {title}
      </h1>
      <div className="auth-form">
        ...
        <div className="recovery-code-warning">
          <DynamicIcon name="alert" size={14} /> الكود ده مش هيتعرض تاني أبدًا بعد ما تسيب الشاشة دي. لو ضاع منك ومنسيتش كلمة مرورك، تقدر تولّد كود جديد
