...
import { createLifeArea } from '@/lib/api/api';
import { LifeAreaData, DEFAULT_LIFE_AREA_COLOR, hexToGradient } from '@/lib/core/lifeArea';
import { ColorGroups, IconGroups } from '@/components/life-areas/LifeAreasManager';
