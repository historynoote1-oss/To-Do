...
//     ملحوظة: لو الجهاز فتح التطبيق ومفيش نت خالص، فيه صفحة أوفلاين محلية
//     (android-native/assets/offline.html + OfflineFallback.kt) بتظهر بدل
//     صفحة خطأ النظام الافتراضية — من غير ما نضطر نبدّل لوضع Bundled.
//
